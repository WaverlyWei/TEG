---
title: "Relative Performance of Standard Labs, TEG and Rotem for Predicting Outcomes"
header-includes: \usepackage{graphicx}
bibliography: stat2.bib
output:
  pdf_document:
    fig_width: 7
    fig_height: 6
...
### Re-do outcomes
#inc=agrep(out[2],names(dataf),max.distance = 0.5,value=T)
#inc=agrep(out[3],names(dataf),max.distance = 0.1,value=T)
...
#    SL.library <- c("SL.glmnet", "SL.randomForest", "SL.knn_stored", "SL.mean")
...
plot(1-slot(perf1,"x.values")[[1]],slot(perf1,"y.values")[[1]],type="s",xlab="1-Specificity",ylab="Sensitivity",
     main=paste("Results for ",outc," vs ",prednmes[1],sep=""))
